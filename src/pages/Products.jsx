...
export default function Products() {
  ...
  useEffect(() => {
    ...
    else if (sortBy === 'price_desc') result.sort((a, b) => b.precio - a.precio)
    else if (sortBy === 'featured') result.sort((a, b) => (b.destacado ? 1 : 0) - (a.destacado ? 1 : 0))
    setFiltered(result)
    ...
    <div className={styles.page}>
      <div className="container">
        <div className={styles.pageHeader}>
          <h1 className="page-title">SMART TVs</h1>
          <p className={styles.subtitle}>La mejor selección para el Mundial 2026</p>
        </div>
